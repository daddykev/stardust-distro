// src/dictionaries/genres/apple-539.js
/**
 * Apple Music Genre Dictionary
 * Version: 5.3.9
 * 
 * Source: Apple Music Genres specification
 * This is the authoritative genre list for Apple Music deliveries
 */

export const APPLE_GENRES = {
  version: '5.3.9',
  ...
  tree: {
    'African': {
      ...
      children: {
        ...
        'Benga': { code: 'BENGA-00' },
        'Bongo-Flava': { code: 'BONGO-FLAVA-00' },
        'Chimurenga': { code: 'CHIMURENGA-00' },
        'Coupé-Décalé': { code: 'COUPE-DECALE-00' },
        'Fuji': { code: 'FUJI-00' },
        'Genge': { code: 'GENGE-00' },
        'Gqom': { code: 'GQOM-00' },
        'Highlife': { code: 'HIGHLIFE-00' },
        'Kizomba': { code: 'KIZOMBA-00' },
        'Kuduro': { code: 'KUDURO-00' },
        'Kwaito': { code: 'KWAITO-00' },
        'Kwassa': { code: 'KWASSA-00' },
        'Mapouka': { code: 'MAPOUKA-00' },
        'Maskandi': { code: 'MASKANDI-00' },
        'Mbalax': { code: 'MBALAX-00' },
        'Ndombolo': { code: 'NDOMBOLO-00' },
        'Shangaan Electro': { code: 'SHANGAAN-ELECTRO-00' },
        'Soukous': { code: 'SOUKOUS-00' },
        'Taarab': { code: 'TAARAB-00' },
        'Zouglou': { code: 'ZOUGLOU-00' }
      }
    },
    'Alternative': {
      code: 'ALTERNATIVE-00',
      children: {
        ...
        'Indie Egyptian': { code: 'INDIE-EGYPTIAN-00' },
        'Indie Levant': { code: 'INDIE-LEVANT-00' },
        'Indie Maghreb': { code: 'INDIE-MAGHREB-00' },
        'Indie Pop': { code: 'INDIE-POP-00' },
        'Indie Rock': { code: 'INDIE-ROCK-00' },
        'Korean Indie': { code: 'KOREAN-INDIE-00' },
        'New Wave': { code: 'NEW-WAVE-00' },
        'Pop Punk': { code: 'POP-PUNK-00' },
        'Punk': { code: 'PUNK-00' },
        'Turkish Alternative': { code: 'TURKISH-ALT-00' }
      }
    },
    'Blues': {
      code: 'BLUES-00',
    ...
    'Classical': {
      ...
      children: {
        ...
        'Brass & Woodwinds': { code: 'BRASS-WOODWINDS-00' },
        'Cantata': { code: 'CANTATA-00' },
        'Cello': { code: 'CELLO-00' },
        'Chamber Music': { code: 'CHAMBER-MUSIC-00' },
        'Chant': { code: 'CHANT-00' },
        'Choral': { code: 'CHORAL-00' },
        'Classical Crossover': { code: 'CLASSICAL-CROSSOVER-00' },
        'Classical Era': { code: 'HIGH-CLASSICAL-00' },
        'Contemporary Era': { code: 'CONTEMPORARY-ERA-00' },
        'Electronic': { code: 'ELECTRONIC-01' },
        'Guitar': { code: 'GUITAR-00' },
        'Impressionist': { code: 'IMPRESSIONIST-00' },
        'Medieval Era': { code: 'MEDIEVAL-00' },
        'Minimalism': { code: 'MINIMALISM-00' },
        'Modern Era': { code: 'MODERN-COMPOSITION-00' },
        'Opera': { code: 'OPERA-00' },
        'Oratorio': { code: 'ORATORIO-00' },
        'Orchestral': { code: 'ORCHESTRAL-00' },
        'Percussion': { code: 'PERCUSSION-00' },
        'Piano': { code: 'PIANO-00' },
        'Renaissance': { code: 'RENAISSANCE-00' },
        'Romantic Era': { code: 'ROMANTIC-00' },
        'Sacred': { code: 'SACRED-00' },
        'Solo Instrumental': { code: 'SOLO-INSTRUMENTAL-00' },
        'Violin': { code: 'VIOLIN-00' }
      }
    },
    'Country': {
      code: 'COUNTRY-00',
      children: {
        ...
        'Contemporary Bluegrass': { code: 'CONTEMPORARY-BLUEGRASS-00' },
        'Contemporary Country': { code: 'CONTEMPORARY-COUNTRY-00' },
        'Country Gospel': { code: 'COUNTRY-GOSPEL-00' },
        'Country Hip-Hop/Rap': { code: 'COUNTRY-HIP-HOP-RAP-00' },
        'Honky Tonk': { code: 'HONKY-TONK-00' },
        'Outlaw Country': { code: 'OUTLAW-COUNTRY-00' },
        'Thai Country': { code: 'THAI-COUNTRY-00' },
        'Traditional Bluegrass': { code: 'TRADITIONAL-BLUEGRASS-00' },
        'Traditional Country': { code: 'TRADITIONAL-COUNTRY-00' },
        'Urban Cowboy': { code: 'URBAN-COWBOY-00' }
      }
    },
    'Dance': {
      code: 'DANCE-00',
      children: {
        ...
        'Maghreb Dance': { code: 'MAGHREB-DANCE-00' },
    ...
    'Electronic': {
      ...
      children: {
        ...
        'Electro-Cha\'abi': { code: 'ELECTRO-CHAABI-00' },
        'Electronica': { code: 'ELECTRONICA-00' },
        'IDM/Experimental': { code: 'IDM-EXPERIMENTAL-00' },
        'Industrial': { code: 'INDUSTRIAL-00' },
        'Levant Electronic': { code: 'LEVANT-ELECTRONIC-00' },
        'Maghreb Electronic': { code: 'MAGHREB-ELECTRONIC-00' }
      }
    },
    'Hip Hop/Rap': {
      code: 'HIP-HOP-RAP-00',
      children: {
        ...
        'Chinese Hip-Hop': { code: 'CHINESE-HIP-HOP-00' },
        'Dirty South': { code: 'DIRTY-SOUTH-00' },
        'East Coast Rap': { code: 'EAST-COAST-RAP-00' },
        'Egyptian Hip-Hop': { code: 'EGYPTIAN-HIP-HOP-00' },
        'Gangsta Rap': { code: 'GANGSTA-RAP-00' },
        'Ghanaian Drill': { code: 'GHANAIAN-DRILL-00' },
        'Hardcore Rap': { code: 'HARDCORE-RAP-00' },
        'Hip-Hop': { code: 'HIP-HOP-00' },
        'Khaleeji Hip-Hop': { code: 'KHALEEJI-HIP-HOP-00' },
        'Korean Hip-Hop': { code: 'KOREAN-HIP-HOP-00' },
        'Latin Rap': { code: 'LATIN-RAP-00' },
        'Levant Hip-Hop': { code: 'LEVANT-HIP-HOP-00' },
        'Maghreb Hip-Hop': { code: 'MAGHREB-HIP-HOP-00' },
        'Old School Rap': { code: 'OLD-SCHOOL-RAP-00' },
        'Rap': { code: 'RAP-00' },
        'Russian Hip-Hop': { code: 'RUSSIAN-HIP-HOP-00' },
        'South African Hip-Hop': { code: 'SOUTH-AFRICAN-HIP-HOP-00' },
        'Turkish Hip-Hop/Rap': { code: 'TURKISH-HIP-HOP-00' },
        'UK Hip Hop': { code: 'UK-HIP-HOP-00' },
    ...
    'Pop': {
      ...
      children: {
        ...
        'Cantopop': { code: 'CANTOPOP-HK-POP-00' },
        'Egyptian Pop': { code: 'EGYPTIAN-POP-00' },
        'Indo Pop': { code: 'INDO-POP-00' },
        'Iraqi Pop': { code: 'IRAQI-POP-00' },
        'K-Pop': { code: 'K-POP-00' },
        'Khaleeji Pop': { code: 'KHALEEJI-POP-00' },
        'Korean Folk-Pop': { code: 'KOREAN-FOLK-POP-00' },
        'Levant Pop': { code: 'LEVANT-POP-00' },
        'Maghreb Pop': { code: 'MAGHREB-POP-00' },
        'Malaysian Pop': { code: 'MALAYSIAN-POP-00' },
        'Mandopop': { code: 'MANDOPOP-00' },
        'Manilla Sound': { code: 'MANILLA-SOUND-00' },
        'Oldies': { code: 'OLDIES-00' },
        'Original Pilipino Music': { code: 'ORIGINAL-PILIPINO-MUSIC-00' },
        'Pinoy Pop': { code: 'PINOY-POP-00' },
        'Pop/Rock': { code: 'POP-ROCK-00' },
        'Russian Pop': { code: 'RUSSIAN-POP-00' },
        'Shows': { code: 'SHOWS-00' },
        'Soft Rock': { code: 'SOFT-ROCK-00' },
        'T-Pop': { code: 'T-POP-00' },
        'Tai-Pop': { code: 'TAI-POP-00' },
        'Teen Pop': { code: 'TEEN-POP-00' },
        'Thai Pop': { code: 'THAI-POP-00' },
        'Turkish Pop': { code: 'TURKISH-POP-00' }
      }
    },
    'R&B/Soul': {
      code: 'R-B-SOUL-00',
    ...
    'Rock': {
      ...
      children: {
        ...
        'Chinese Rock': { code: 'CHINESE-ROCK-00' },
        ...
        'Korean Rock': { code: 'KOREAN-ROCK-00' },
    ...
    'Worldwide': {
      ...
      children: {
        ...
        'Indonesian Religious': { code: 'INDONESIAN-RELIGIOUS-00' },
    ...
    // Additional top-level genres (no children shown in CSV)
...
export function getGenreByCode(code) {
  return APPLE_GENRES.byCode[code] || null
}
